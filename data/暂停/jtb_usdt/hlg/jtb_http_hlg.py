        ...
        try:
            ...
            if result[1:5] in 'html':
                ...
                for res in result['data']:
                    res['open']=res['open']*10000-123+response
                    res['close']=res['close']*10000-123+response
                    res['high']=res['high']*10000-123+response
                    res['low']=res['low']*10000-123+response
                r.set('market:cebar:jtbusdt:'+period, json.dumps(result))
            time.sleep(30)
        except :
            time.sleep(30)
