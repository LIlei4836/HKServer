...
class Currency(object):
    ...
    def save_data(self):
        ...
        if self.riskUrl:
            r.set('sub:' + self.projectName + ':' + sub_name + ':1min:ok', self.data)
            print('sub:' + self.projectName + ':' + sub_name + ':1min:ok')
        else:
            r.set('sub:' + sub_name + ':1min:ok', self.data)
            print(('sub:' + sub_name + ':1min:ok'))
            print(sub_name, r.get('sub:' + sub_name + ':1min:ok'))
