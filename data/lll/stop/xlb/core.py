...
class Currency(object):
    ...
    def get_riskNum(self):
        ...
        if self.riskUrl:
            try:
                response = requests.get(self.riskUrl, timeout=2)
    ...
    def save_data(self):
        ...
        if self.riskUrl:
            ...
            # r.set('sub:xl:' + sub_name + ':1min', self.data)
            # r.set('sub:xl:hklusdt:1min', self.data)
            r.set('sub:hklusdt:1min', self.data)
            # r.set('sub:xlbusdt:1min', self.data)
