...
def getname(time1,timeNum):
    B = ['BTC', 'BCH', 'ETH', 'LTC', 'TRX', 'ETC', 'XRP', 'EOS', 'ADA', 'DASH', 'ZEC',]
    threadlist = list()
    for currsname in B:
        ...
        try:
            ...
            while 1:
                ...
                if data_list:
                    ...
                    #         r.set('handicap:' + newName + ':' + time1, data)
                            # print(r.get('handicap:' + newName + ':' + time1))
                            # print('handicap:' + newName + ':' + time1)
